...
spool "l6_&filename..log"

-- Password file execution
@passworddefinition.sql

PROMPT Dropping Role ROLE_l6 ...
DROP ROLE ROLE_l6 ;
PROMPT Creating Role ROLE_l6 ...
CREATE ROLE ROLE_l6 ;

-- PROMPT Drop Lice user
-- drop user Lice cascade;
   
PROMPT Create user Lice
CREATE USER Lice IDENTIFIED BY &&Lice_password PASSWORD EXPIRE ACCOUNT LOCK /* DEFAULT TABLESPACE USERS  TEMPORARY TABLESPACE TEMP */;
GRANT CREATE SESSION, RESOURCE, CREATE VIEW, CREATE MATERIALIZED VIEW, CREATE SYNONYM, UNLIMITED TABLESPACE TO Lice;
...
GRANT ALL ON utils TO ROLE_l6;
grant ALL on utils to Lice with grant option;

set define on
prompt connecting to Lice
alter session set current_schema=Lice;
set define off
-- DROP TABLE Software CASCADE CONSTRAINTS;


PROMPT Creating Table Software ...
...
PROMPT Creating Primary Key Constraint PK__Software__3214EC277C6B3D93 on table Software ... 
ALTER TABLE Software
ADD CONSTRAINT PK__Software__3214EC277C6B3D93 PRIMARY KEY
(
  ID
)
ENABLE
...
GRANT ALL ON Software TO ROLE_l6;
-- DROP TABLE UserLicenses CASCADE CONSTRAINTS;


PROMPT Creating Table UserLicenses ...
CREATE TABLE UserLicenses (
  ID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  UserID NUMBER(10,0) NOT NULL,
  LicenseID NUMBER(10,0) NOT NULL,
  LicenseKey VARCHAR2(50 CHAR) NOT NULL,
  StartDate VARCHAR2(200 CHAR) NOT NULL,
  EndDate VARCHAR2(200 CHAR) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__UserLice__3214EC27176645F4 on table UserLicenses ... 
ALTER TABLE UserLicenses
ADD CONSTRAINT PK__UserLice__3214EC27176645F4 PRIMARY KEY
(
  ID
)
ENABLE
...
GRANT ALL ON UserLicenses TO ROLE_l6;
-- DROP TABLE Licenses CASCADE CONSTRAINTS;


PROMPT Creating Table Licenses ...
CREATE TABLE Licenses (
  ID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  SoftwareID NUMBER(10,0) NOT NULL,
  Price NUMBER(10,0) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__Licenses__3214EC27215D1B21 on table Licenses ... 
ALTER TABLE Licenses
ADD CONSTRAINT PK__Licenses__3214EC27215D1B21 PRIMARY KEY
(
  ID
)
ENABLE
...
GRANT ALL ON Licenses TO ROLE_l6;
-- DROP TABLE Userr CASCADE CONSTRAINTS;


PROMPT Creating Table Userr ...
CREATE TABLE Userr (
  ID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  Name VARCHAR2(50 CHAR) NOT NULL,
...
PROMPT Creating Primary Key Constraint PK__Userr__3214EC274EB4C549 on table Userr ... 
ALTER TABLE Userr
ADD CONSTRAINT PK__Userr__3214EC274EB4C549 PRIMARY KEY
(
  ID
)
ENABLE
...
alter session set current_schema=Lice;
set define off
PROMPT Creating Foreign Key Constraint FK__Licenses__Softwa__3A81B327 on table Software...
ALTER TABLE Licenses
ADD CONSTRAINT FK__Licenses__Softwa__3A81B327 FOREIGN KEY
(
  SoftwareID
)
REFERENCES Software
...
PROMPT Creating Foreign Key Constraint FK__UserLicen__UserI__3D5E1FD2 on table Userr...
ALTER TABLE UserLicenses
ADD CONSTRAINT FK__UserLicen__UserI__3D5E1FD2 FOREIGN KEY
(
  UserID
)
REFERENCES Userr
...
PROMPT Creating Foreign Key Constraint FK__UserLicen__Licen__3E52440B on table Licenses...
ALTER TABLE UserLicenses
ADD CONSTRAINT FK__UserLicen__Licen__3E52440B FOREIGN KEY
(
  LicenseID
)
REFERENCES Licenses
